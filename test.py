...
from src.trainingdata.get_faces_from_camera import TrainingDataCollector
...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        link2 = tk.Label(self.window, text="inception", fg="blue", )
        link2.place(x=690, y=580)
        # link2.pack()
        link2.bind("<Button-1>", lambda e: self.callback("https://www.facebook.com/inceptionforfuture"))
    ...
    def collectUserImageForRegistration(self):
        ...
        dt_string = current_times.strftime("%I %M %p")
        ...
        df.to_csv('hiatory.csv', mode='a', index=False, header=False)
